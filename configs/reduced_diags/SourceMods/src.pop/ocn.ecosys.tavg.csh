#!/bin/csh -f
## Modifed by SFBT to have stream#1 (originally daily) be monthly
# and stream#2 (origincally monthly) to be annual.
# Aim to reduce data volume output by at least an order of magnitude.
...
tavg_stream_filestrings   = 'ecosys.nmonth' 'ecosys.nyear1'
EOF
